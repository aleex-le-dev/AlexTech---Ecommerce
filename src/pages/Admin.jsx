...
import { Package, Users, Plus, Edit, Trash2, Eye, X, ShoppingCart, FolderOpen, FileText, CreditCard } from 'lucide-react';
                    ...
                    <tr key={content.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                          ...
                          <button 
                            onClick={() => confirmDelete(content, 'content')}
                            className="text-red-600 hover:text-red-900"
            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <div className="mb-6">
                <p className="text-gray-700 mb-2">
                  Êtes-vous sûr de vouloir supprimer {deleteType === 'product' ? 'le produit' : 'l\'utilisateur'} :
                </p>
                <p className="font-semibold text-lg">
                  {deleteType === 'product' ? itemToDelete.name : itemToDelete.name}
                </p>
